 ...
 * |      |      | [^ ] | [^^] | [ ^] |[ - ] |      | Home |  Up  | End  |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      | [< ] | [<>] | [ >] |[XYZ] |Pg Up | Left | Down | Right|      |LckScr|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      | [v ] | [vv] | [ v] |[ZYX] |Pg Dn |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
...
[_ARROWS] = LAYOUT_planck_grid(
  _______, _______, SP_TLFT, SP_TOP,  SP_TRGH, SP_CENT, _______, KC_HOME, KC_UP,   KC_END,  _______, _______,
  _______, _______, SP_LEFT, SP_FULL, SP_RGHT, SP_NTHR, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, _______, LCK_SCR,
  _______, _______, SP_BLFT, SP_BOTT, SP_BRGH, SP_PTHR, KC_PGDN, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
